...
@section('content')
    ...
    <div class="container" style="margin-top:80px;">
           ...
           <h2 class="" style="font-weight:700; margin-left:380px;">Your shorten Url </h2>
           </div>

           </div>
           <p class="text-center">Copy the shortened link and share it in messages, texts, posts, websites and other locations.</p>
    </div> 


<div class="container-fluid bg-dark h-25 " ">
  ...
  <div class="row p-5" ">
    ...
    <div class="col col-2">
      ...
      <button type="button" id="button2" class="btn btn-success ">copy</button>

      </form>
    </div>

     <h5 class="text-light">Your Long url : {{$url->url}} </br></h5>
  </div>
    ...
    <section id="services" class="services pb-5">
      <div class="container">
        ...
        <div class="section-title text-center p-5">
          ...
          <h3>Hey there,we are poviding some  more extra cool feature , </h3>
